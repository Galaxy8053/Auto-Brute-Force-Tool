...
async def kkfofa_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if total_size <= 10000:
        ...
        keyboard = [[InlineKeyboardButton("按天下载 (穷人模式)", callback_data='mode_daily')],[InlineKeyboardButton("全部下载 (消耗F点)", callback_data='mode_full')],[InlineKeyboardButton("仅预览前20条", callback_data='mode_preview')],[InlineKeyboardButton("取消", callback_data='mode_cancel')],]
